...
CustomParser._LITERAL_NAMES = [undefined, undefined, "'vrai'", "'faux'", "'interromps'", "'constant'", "'continue'", "'sinon'", "'fin'", "'pour'", "'pour toujours'", "'de'", "'fonction'", "'global'", "'si'", "'retourne'", "'renvoie'", "'jusqua'", "'tant que'", undefined, undefined, undefined, "'logique'", "'nombre'", "'texte'", "'='", "'+'", "'-'", "'*'", "'/'", "'%'", "'^'", "'+='", "'-='", "'*='", "'/='", "'%='", "'^='", "'<'", "'<='", "'>'", "'>='", "'=='", "'!='", "'('", "')'", "'['", "']'", "'{'", "'}'", "'.'", "','"];
