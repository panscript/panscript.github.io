"use strict";
(self["webpackChunkpanscript"] = self["webpackChunkpanscript"] || []).push([["src_languages_fr_fr_generated_CustomParser_ts"],{

/***/ "./src/languages/fr_fr/generated/CustomParser.ts":
/*!*******************************************************!*\
  !*** ./src/languages/fr_fr/generated/CustomParser.ts ***!
  \*******************************************************/
    ...
    value: function program() {
      ...
      try {
        this.enterOuterAlt(_localctx, 1);
        {
          ...
          while ((_la & ~0x1F) === 0 && (1 << _la & (1 << CustomParser.LIST | 1 << CustomParser.CONSTANT | 1 << CustomParser.FOR | 1 << CustomParser.FUNCTION | 1 << CustomParser.IF | 1 << CustomParser.FOREVER | 1 << CustomParser.WHILE | 1 << CustomParser.LOGICAL | 1 << CustomParser.NUMBER | 1 << CustomParser.TEXT)) !== 0 || _la === CustomParser.IDENTIFIER) {
            {
              {
                this.state = 60;
                this.topStatement();
    ...
    value: function functionDeclaration() {
      ...
      try {
        this.enterOuterAlt(_localctx, 1);
        {
          ...
          if ((_la & ~0x1F) === 0 && (1 << _la & (1 << CustomParser.LIST | 1 << CustomParser.LOGICAL | 1 << CustomParser.NUMBER | 1 << CustomParser.TEXT)) !== 0) {
            {
              this.state = 116;
              this.parameterList();
            }
          ...
          while ((_la & ~0x1F) === 0 && (1 << _la & (1 << CustomParser.LIST | 1 << CustomParser.BREAK | 1 << CustomParser.CONSTANT | 1 << CustomParser.CONTINUE | 1 << CustomParser.FOR | 1 << CustomParser.GLOBAL | 1 << CustomParser.IF | 1 << CustomParser.FOREVER | 1 << CustomParser.RETURN | 1 << CustomParser.WHILE | 1 << CustomParser.LOGICAL | 1 << CustomParser.NUMBER | 1 << CustomParser.TEXT)) !== 0 || _la === CustomParser.IDENTIFIER) {
            {
              {
                this.state = 129;
                this.innerStatement();
        ...
        switch (this._input.LA(1)) {
          case CustomParser.LIST:
            this.enterOuterAlt(_localctx, 1);
            {
              ...
              if ((_la & ~0x1F) === 0 && (1 << _la & (1 << CustomParser.TRUE | 1 << CustomParser.FALSE | 1 << CustomParser.LIST | 1 << CustomParser.NOT | 1 << CustomParser.ADD | 1 << CustomParser.SUBTRACT)) !== 0 || (_la - 44 & ~0x1F) === 0 && (1 << _la - 44 & (1 << CustomParser.OPEN_PARENTHESIS - 44 | 1 << CustomParser.QUOTE_SINGLE - 44 | 1 << CustomParser.QUOTE_DOUBLE - 44 | 1 << CustomParser.IDENTIFIER - 44 | 1 << CustomParser.DECIMAL_NUMBER - 44 | 1 << CustomParser.HEX_NUMBER - 44 | 1 << CustomParser.BINARY_NUMBER - 44)) !== 0) {
                {
                  this.state = 264;
                  this.argumentList();
                }
...
CustomParser._LITERAL_NAMES = [undefined, undefined, "'vrai'", "'faux'", "'liste'", "'interromps'", "'constant'", "'continue'", "'sinon'", "'fin'", "'pour'", "'fonction'", "'global'", "'si'", "'en'", "'toujours'", "'retourne'", "'renvoie'", "'tant que'", undefined, undefined, undefined, "'logique'", "'nombre'", "'texte'", "'='", "'+'", "'-'", "'*'", "'/'", "'%'", "'^'", "'+='", "'-='", "'*='", "'/='", "'%='", "'^='", "'<'", "'<='", "'>'", "'>='", "'=='", "'!='", "'('", "')'", "'['", "']'", "'{'", "'}'", "'.'", "','"];
CustomParser._SYMBOLIC_NAMES = [undefined, "TEXT_CONTENT", "TRUE", "FALSE", "LIST", "BREAK", "CONSTANT", "CONTINUE", "ELSE", "END", "FOR", "FUNCTION", "GLOBAL", "IF", "IN", "FOREVER", "RETURN", "RETURNS", "WHILE", "AND", "OR", "NOT", "LOGICAL", "NUMBER", "TEXT", "ASSIGN", "ADD", "SUBTRACT", "MULTIPLY", "DIVIDE", "REMAINDER", "POWER", "ADD_ASSIGN", "SUBTRACT_ASSIGN", "MULTIPLY_ASSIGN", "DIVIDE_ASSIGN", "REMAINDER_ASSIGN", "POWER_ASSIGN", "LESS", "LESS_OR_EQUAL", "GREATER", "GREATER_OR_EQUAL", "EQUAL", "DIFFERENT", "OPEN_PARENTHESIS", "CLOSE_PARENTHESIS", "OPEN_BRACKET", "CLOSE_BRACKET", "OPEN_BRACE", "CLOSE_BRACE", "DOT", "COMMA", "QUOTE_SINGLE", "QUOTE_DOUBLE", "IDENTIFIER", "DECIMAL_NUMBER", "HEX_NUMBER", "BINARY_NUMBER", "NEWLINE", "WHITESPACE", "LINE_COMMENT", "BLOCK_COMMENT", "UNKNOWN", "SINGLE_QUOTE_NEWLINE", "DOUBLE_QUOTE_NEWLINE"];
