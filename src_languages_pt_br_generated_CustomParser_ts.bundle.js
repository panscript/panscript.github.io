...
CustomParser._LITERAL_NAMES = [undefined, undefined, "'verdadeiro'", "'falso'", "'lista'", "'interrompa'", "'constante'", "'continue'", "'sen\xE3o'", "'fim'", "'para'", "'fun\xE7\xE3o'", "'global'", "'se'", "'em'", "'para sempre'", "'retorne'", "'retorna'", "'enquanto'", undefined, undefined, undefined, "'l\xF3gico'", "'n\xFAmero'", "'texto'", "'='", "'+'", "'-'", "'*'", "'/'", "'%'", "'^'", "'+='", "'-='", "'*='", "'/='", "'%='", "'^='", "'<'", "'<='", "'>'", "'>='", "'=='", "'!='", "'('", "')'", "'['", "']'", "'{'", "'}'", "'.'", "','"];
